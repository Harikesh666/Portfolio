...
- Proof on hand: `Harikesh_Mishra_Resume.pdf`, including production work on a 130K+ record dataset, multi-tenant isolation for five client organizations, eight end-to-end admin pages, a 35% SQL performance improvement, and same-day production and security fixes.
