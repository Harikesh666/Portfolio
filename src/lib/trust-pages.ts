...
export const privacyText = [
    "This is a personal portfolio and technical writing website operated by Harikesh Mishra. It does not provide user accounts, comments, purchases, advertising, or a contact form. The site does not currently use analytics services, advertising trackers, tracking pixels, or marketing cookies.",
    "The theme control stores a light or dark preference in your browser's local storage. That value stays on your device and is used only to preserve the appearance you selected. The website does not use that preference to identify you or build a profile.",
    "When you visit the site, the hosting and network providers that deliver it may process standard request information such as an IP address, requested URL, browser details, timestamps, and security logs. They use this information to operate, secure, and diagnose the service. Their handling is governed by their own terms and privacy practices.",
    "If you email or call me, you choose to provide your contact details and message content. I use that information only to read, answer, and keep the context of our conversation. Your email or telephone provider also processes that communication under its own terms. Do not send passwords, payment-card data, government identifiers, confidential production credentials, or other sensitive information through ordinary email.",
